  ...
  * {
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="datatanggapan.php">Data Pengaduan</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="tanggapan.php">Data Tanggapan</a>
        </li>
        <li class="nav-item">
    ...
    <!---- navbar --->
      <!---- container --->
    <div class="container">
    <h3 class="mt-4 text-white"><i class="bi bi-flag-fill"></i>&nbsp;Data Tanggapan </h3>
    <hr>
   <!---- tabel ---->
   <div class="card mt-4">
                                ...
                                <table class="table table-bordered table-striped" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_POST['bcari'])){
                                            $keyword = $_POST['tcari'];
                                            $q = "select * from tanggapan where id_tanggapan like '%$keyword%' or id_pengaduan like '%$keyword%' or tgl_tanggapan like '%$keyword%' or tanggapan like '%$keyword%'";
                                           }else{
                                        ...
                                        foreach ($input as $row) {
                                            echo "<tr>
                                               <td>" . $urut++ . "</td>
                                                ...
                                                <td>" . $row['tanggapan'] . "</td>
                                                <td><a href='edit.php?id_tanggapan=$row[id_tanggapan]'><button class='btn btn-sm btn-secondary'><i class='bi bi-pencil'></i>&nbsp;Edit</button></a>
                                                <a href='delete.php?id_tanggapan=$row[id_tanggapan]'><button class='btn btn-sm btn-danger text-white'><i class='bi bi-trash-fill'></i>&nbsp;Hapus</button></a></td>
                                            </tr>";
                                        }
                                        ?>
                                    </tbody>
